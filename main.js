...
function render(Task) {
			...
			//var subj = Task.subject
			//we need to add a subject to the message field of the preview batch and preview tasks.
			var htmlEmail = Task.message
			var batchId = Task.batchId
			//var textEmail = Task.textmessage
